...
graph TB
    subgraph "Cliente"
        APP[ðŸ“± App Flutter<br/>Android / iOS / Web]
    end

    subgraph "VittaHub Backend (MonÃ³lito)"
        AUTH[ðŸ” AuthFlowManager<br/>MFA + RBAC]
        BIZ[âš™ï¸ Regras de NegÃ³cio<br/>DDD / Bounded Contexts]
        ACL[ðŸ”„ Camada ACL<br/>Anti-Corruption Layer]
        AUDIT[ðŸ“‹ Auditoria<br/>Logs de Acesso]
    end
    ...
    subgraph "Sistema Externo"
        MV[ðŸ¥ Sistema MV<br/>ProntuÃ¡rio EletrÃ´nico]
    end
...
|---|:---:|---|
| Modelagem de DomÃ­nio (DDD) | ðŸŸ¢ | SÃ³lida, com Linguagem UbÃ­qua e Event Storming |
| Desacoplamento do MV (ACL) | ðŸŸ¢ | DecisÃ£o estratÃ©gica bem fundamentada |
| SeguranÃ§a e LGPD | ðŸŸ¢ | Privacy by Design com MFA, RBAC, criptografia |
| Stack tecnolÃ³gica | ðŸŸ¢ | Unificada e adequada ao estÃ¡gio do produto |
| ClassificaÃ§Ã£o arquitetural | ðŸŸ¡ | Descrita como microsserviÃ§os, Ã© monÃ³lito modular |
| Camadas internas do backend | ðŸŸ¡ | DDD presente, mas sem separaÃ§Ã£o formal de camadas |
| Observabilidade | ðŸ”´ | Indefinida â€” risco operacional e de compliance |
| Contratos entre mÃ³dulos | ðŸŸ¡ | Bounded Contexts identificados, mas sem interfaces formais |
