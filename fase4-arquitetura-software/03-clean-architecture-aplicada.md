...
```mermaid
graph TB
    subgraph EXT["ðŸ”§ Camada 4: Frameworks & Drivers"]
        direction TB
        FL[Flutter App]
        ORA[Oracle Database]
    ...
    subgraph ADAPT["ðŸ”Œ Camada 3: Interface Adapters"]
        direction TB
    ...
    subgraph ENT["ðŸ›ï¸ Camada 1: Entities - DomÃ­nio"]
        direction TB
        E1[Paciente]
        E2[BoletimMedico]
...
### ðŸ›ï¸ Camada 1: Entities (DomÃ­nio)
...
### ðŸ”Œ Camada 3: Interface Adapters
...
### ðŸ”§ Camada 4: Frameworks & Drivers
...
```
lib/
â”œâ”€â”€ domain/                          # ðŸ›ï¸ Camada 1: Entities
â”‚   â”œâ”€â”€ entities/
...
â”‚
â”œâ”€â”€ adapters/                        # ðŸ”Œ Camada 3: Interface Adapters
...
â”‚
â””â”€â”€ infrastructure/                  # ðŸ”§ Camada 4: Frameworks & Drivers
    â”œâ”€â”€ database/
...
```mermaid
graph LR
    subgraph "ðŸ”§ Frameworks & Drivers"
        FLUTTER[Flutter App]
    ...
    subgraph "ðŸ”Œ Interface Adapters"
        CTRL[Controllers]
